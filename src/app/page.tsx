...
export default function HomePage() {
  ...
  // Handle randomization and fallback to mock data if Firestore is empty
  useEffect(() => {
    if (isLoading) return;
      ...
      <section className="relative h-[700px] md:h-[650px] flex items-center justify-center overflow-hidden">
        ...
        <div className="container relative z-10 px-4 text-center text-white">
          ...
          <p className="text-base md:text-xl mb-10 max-w-3xl mx-auto font-body opacity-90 leading-relaxed">
            RentoVerse makes finding, listing, and sharing your next property effortless with intuitive search and reliable tools.
          </p>
      ...
      <section className="py-24 bg-primary/5 border-y border-primary/10">
        <div className="container px-4 mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
            List your property in minutes and connect with verified tenants directly.
          </p>
          <Link href="/rooms/new">
      ...
      <footer className="py-16 bg-white border-t">
        <div className="container px-4 mx-auto flex flex-col items-center">
          <div className="relative mb-6 flex justify-center items-center">
            ...
            <span className="ml-2 text-2xl font-headline font-bold text-primary">RentoVerse</span>
          </div>
